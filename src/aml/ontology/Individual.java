...
//Attributes
	...
	private Table2Set<Integer, Set> objectValues;
...
//Constructors
	...
	{
		index = i;
		//TODO: Check that it is really formula here
		name = StringParser.normalizeFormula(n);
		dataValues = new Table2Set<Integer,String>();
		objectValues = new Table2Set<Integer,Set>();
	}
...
//Public Methods
	...
	/**
	 * Adds a given value to this Individual
	 * @param propIndex: the index of the ObjectProperty associated with this Individual
	 * @param value: the value of the ObjectProperty for this Individual
	 */
	public void addObjectValue(int propIndex, Set value)
	{
		objectValues.add(propIndex,value);
	}
	 ...
	 * @return the value of the DataProperty for this Individual 
	 */
	public Set<Set> getObjectValue(int propIndex)
	{
		return objectValues.get(propIndex);
	}
